...
class Data:
    ...
    Time_Avilable =  [["Mon", " 09:00 - 10:00"],
                      ["Mon", " 10:00 - 11:00"],
                      ["Th", " 09:00 - 10:30"],
                      ["Th", " 10:30 - 12:00"]]

    INSTRUCTORS = [["11", "DR Ahmed Omar"],
                   ["12", "DR Mostafa Gamal"],
                   ["13", "DR Salwa "],
                   ["14", "DR Mohammed ٍElSayed"]]
    # Sample lvl 2
    ROOMS2 = [["B1", 25], ["B2", 45], ["F3", 35]]
    Time_Avilable2 = [["Mon", " 8:00 - 9:00"],
                      ["Mon", " 10:00 - 11:00"],
                      ["We", " 08:00 - 10:30"],
                      ["We", " 10:30 - 12:30"]]

    INSTRUCTORS2 = [["11", "DR Osama Sayed "],
                   ["12", "DR Hassam Asem"],
                   ["13", "DR Sara ELDib"],
                   ["14", "DR Jana Mohmmoud"]]
    ...
    def __init__(self,choose):
        ...
        if choose == 1:
            ...
            course1 = Courses("A1", "655K", [self._instructors[0], self._instructors[1]], 25)
            course2 = Courses("D2", "359K", [self._instructors[0], self._instructors[1], self._instructors[2]], 41)
            course3 = Courses("C3", "332K", [self._instructors[0], self._instructors[1]], 19)
            course4 = Courses("C4", "414K", [self._instructors[2], self._instructors[3]], 37)
            course5 = Courses("E5", "340C", [self._instructors[3]], 35)
            course6 = Courses("D6", "393K", [self._instructors[0], self._instructors[2]], 38)
            course7 = Courses("B7", "303L", [self._instructors[1], self._instructors[3]], 45)
        if choose == 2:
            for i in range(0, len(self.ROOMS2)):
                self._rooms.append(Room(self.ROOMS2[i][0], self.ROOMS2[i][1]))
            for i in range(0, len(self.Time_Avilable)):
                self._TimeAvilable.append(TimeAvilable(self.Time_Avilable2[i][0], self.Time_Avilable2[i][1]))
            for i in range(0, len(self.INSTRUCTORS)):
                self._instructors.append(Instructor(self.INSTRUCTORS2[i][0], self.INSTRUCTORS2[i][1]))
...
while (True):
    ...
    NUMB_OFELITE_SCHEDULES = int(input("Enter Rate Of Retain in range (0 , 100): "))
    TORNAMENT_SELECTON_SIZE = int(input("Enter Rate Of Random Select in range (0 , 100): "))
    MUTATION_RATE = float(input("Enter MUTATION_RATE in range (0 , 1): "))
    choose = int(input("Enter Which lvl you  want to Create  Schedule in range ( 1 , 2 ) "))
    if POPULATION_SIZE not in  range (1,100) or NUMB_OFELITE_SCHEDULES not in  range (1,100) or  choose not in  range (1,3):
        print("Out Of Range Please try again")
        print(POPULATION_SIZE not in  range (1,100) or NUMB_OFELITE_SCHEDULES not in  range (1,100) or 0< MUTATION_RATE < 1 or choose not in  range (1,4))
    else:
        data = Data(choose)
        break
